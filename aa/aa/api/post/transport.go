...
import (
	...
	"github.com/aa/aa/api/post/repositories/mysql"
...
func New(router chi.Router, dbClient *sqlx.DB, authSvc *authService.AuthService) {
	a := API{svc: NewController(mysql.NewPostDB(dbClient), authSvc)}
...
func (a *API) show(w http.ResponseWriter, r *http.Request) {
	...
	result, err := a.svc.Show(r.Context(), models.PostID(id))
	if err != nil {
		resp.ReturnError(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (a *API) update(w http.ResponseWriter, r *http.Request) {
	...
	err = a.svc.Update(r.Context(), &updateReq, models.PostID(id))
	if err != nil {
		resp.ReturnError(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (a *API) delete(w http.ResponseWriter, r *http.Request) {
	...
	err = a.svc.Delete(r.Context(), models.PostID(id))
	if err != nil {
		resp.ReturnError(w, err.Error(), http.StatusInternalServerError)
		return
	}
